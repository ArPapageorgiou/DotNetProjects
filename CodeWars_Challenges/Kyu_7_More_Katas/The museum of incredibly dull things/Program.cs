namespace The_museum_of_incredibly_dull_things
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //However, just as she finished rating all exhibits, she's off to an important fair, so she asks you to write
            ...
            //multiple elements with the same value, remove the one with the lowest index. If you get an empty array/ list,
        ...
        public static List<int> RemoveSmallest(int[] ratingsArray)
        {
